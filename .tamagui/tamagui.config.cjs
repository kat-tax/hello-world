...
var require_cjs7 = __commonJS({
  "node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core55.getTokens)().size;
  ...
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    var Image2 = StyledImage.extractable(
      (0, import_react48.forwardRef)((inProps, ref) => {
        const props = (0, import_core55.useProps)(inProps);
...
var require_getFontSize = __commonJS({
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSize4 = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      if ((0, import_core55.isVariable)(res)) {
        return +res.val;
      }
      return res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      const conf = (0, import_core55.getConfig)();
...
var require_getElevation = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size3, extras) => {
      ...
      const sizeNum = (0, import_core55.isVariable)(token) ? +token.val : size3;
...
var require_Group = __commonJS({
  "node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var GroupFrame = (0, import_core55.styled)(import_stacks27.ThemeableStack, {
      name: "GroupFrame",
      variants: {
        unstyled: {
          false: {
      ...
      return (0, import_core55.withStaticProperties)(
        (0, import_react48.forwardRef)((props, ref) => {
          ...
          const {
            ...
            forceUseItem,
            ...restProps
          } = (0, import_core55.getExpandedShorthands)(activeProps);
          ...
          const radius2 = borderRadius ?? (size3 ? (0, import_core55.getVariableValue)((0, import_core55.getTokens)().radius[size3]) - 1 : void 0);
          ...
          const children = isUsingItems ? import_react48.Children.toArray(childrenProp).filter(import_react48.isValidElement) : childrenArray.map((child, i) => {
    ...
    var GroupItem = /* @__PURE__ */ __name((props) => {
      ...
      if ((0, import_core55.isTamaguiElement)(children)) {
    ...
    var cloneElementWithPropOrder = /* @__PURE__ */ __name((child, props) => {
      const next = (0, import_core55.mergeProps)(child.props, props, false, (0, import_core55.getConfig)().shorthands)[0];
...
var require_mutateTheme = __commonJS({
  "node_modules/@tamagui/theme/dist/cjs/_mutateTheme.js"(exports, module2) {
    ...
    function _mutateTheme(props) {
      ...
      const themeProxied = (0, import_web15.proxyThemeToParents)(themeName, theme, config2.themes);
      config2.themes[themeName] = themeProxied;
      let cssRules = [];
      (0, import_web15.updateConfig)("themes", { ...config2.themes, [themeName]: themeProxied });
...
var skipMask = /* @__PURE__ */ __name((template, { skip }) => {
  if (!skip)
    return template;
...
var createShiftMask = /* @__PURE__ */ __name(({ inverse } = {}) => {
  return (template, opts) => {
    const { override, max: maxIn, palette, min: min3 = 0, strength = 1 } = opts;
...
var spaces = Object.entries(size2).map(
...
var tokens = (0, import_core53.createTokens)({
  color,
  space,
  size: size2,
  radius,
...
// src/theme/config.ts
var fonts = {
  body: (0, import_core54.createFont)({
    family: "system",
    size: {
      2: 12,
      3: 14,
  ...
  heading: (0, import_core54.createFont)({
    family: "System",
    size: {
      2: 16,
      3: 20,
...
var config = (0, import_core54.createTamagui)({
